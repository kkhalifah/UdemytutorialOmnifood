    ...
    <body>
       <header id="home">
           <nav>
               ...
               <a href="#home"> <img src="resources/img/logo.png" alt="Omnifood logo" class="logo-black" id="homepage">
                    </a>
        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                <div class="col span-1-of-2 phone">
        ...
        <section class="cities" id="cities">
            ...
            <div class="row js--wp-3">          
                <div class="col span-1-of-4 box">
                    <img src="resources/img/lisbon-3.jpg" class="photo" alt="Lison">
                    <h3>Lisbon</h3>
                ...
                <div class="col span-1-of-4 box">
                        <img src="resources/img/san-francisco.jpg" class="photo" alt="San Francisco">
                    <h3>San Francisco</h3>
                    <div class="city-feature">
                        <i class="ion-ios-star icon-small"></i>
                        160+ top chefs
                ...
                <div class="col span-1-of-4 box">
                    <img src="resources/img/berlin.jpg" class="photo" alt="Berlin">
                        <h3>Berlin</h3>
                    <div class="city-feature">
                        <i class="ion-ios-star icon-small"></i>
                        110+ top chefs
                 ...
                 <div class="col span-1-of-4 box">
                     <img src="resources/img/london.jpg" class="photo" alt="London">
                    <h3>London</h3>
                    <div class="city-feature">
                        <i class="ion-ios-star icon-small"></i>
                        50+ top chefs
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    ...
                    Omnifood is just awesome! I just launched a startup which leaves me with no time for cooking, so Omnifood is a life-saver. Now that I got used to it, I couldn't live without my daily meals!
                        <cite><img src="resources/img/customer-1.jpg" alt="image of male customer"> Alberto Duncan </cite>
                    </blockquote>
                </div>
                ...
                <div class="col span-1-of-3">
                    ...
                    Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
                        <cite><img src="resources/img/customer-2.jpg" alt="image of female customer"> Joana Silva </cite>
                    </blockquote>
                </div>
                ...
                <div class="col span-1-of-3">
                   ...
                   I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                        <cite><img src="resources/img/customer-3.jpg" alt="image of male customer"> Milton Chapman </cite>
                    </blockquote>
                </div>
            </div>
        </section>
       ...
       <div class="map-box">
        ...
        <!-- https://www.jsdelivr.com/ plus jquery--> 
